...
def ping(host, timeout=1):
    ...
    #vars = [str(round(rtt_min, 2)), str(round(rtt_min, 2)), str(round(rtt_max, 2)), str(round(statistics.stdev(rtt_sum), 2))]
    ...
    if rtt_cnt != 0:
        loss = float(100-(100 * (cnt/rtt_cnt)))
        print("")
        ...
        #print(rtt_array)
        print(
            'round-trip min/avg/max/stddev {:.2f}/{:.2f}/{:.2f}/{:.2f} ms'.format(rtt_min, rtt_sum / rtt_cnt, rtt_max,statistics.pstdev(rtt_array)))
